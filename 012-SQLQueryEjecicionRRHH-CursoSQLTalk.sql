...
SET NOCOUNT ON;  ---===> SILENCIA AVISOS DE EJECUCION  Y ASI GANA VELOCIDAD EL MOTOR DE BASE DE DATOS
...
FULL JOIN HumanResources.vEmployeePersonTemporalInfo [HRvE] 
	ON [HRvE].BusinessEntityID = [TMemory].VBusinessEntityID 
